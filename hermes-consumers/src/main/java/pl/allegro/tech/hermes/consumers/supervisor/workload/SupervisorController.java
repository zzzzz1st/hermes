...
public class SupervisorController implements SubscriptionCallback, TopicCallback, SubscriptionAssignmentAware, AdminOperationsCallback {
    ...
    public SupervisorController(ConsumersSupervisor supervisor,
